...
const Sidebar = () => {
  ...
  return (
    <aside class="fixed top-0 left-0 overflow-y-auto w-64 h-screen" aria-label="Sidebar">
    <div class="h-screen overflow-y-auto pt-[50px]  px-3 bg-gray-50  dark:bg-gray-800">
           <a> <img src="./assets/images/logo.svg" class="inline mr-3 h-6 sm:h-7" alt="Flowbite Logo" />
            <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Lecnote</span>
            </a>
        <ul class=" mt-[50px] space-y-2">
        <NavLink to='/'>  <li>
            ...
            <NavLink to='/about'> <li>
                <a class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                <svg aria-hidden="true" class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="#48F4FF" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>
                <span class="flex-1 ml-3 whitespace-nowrap">About</span>
                </a>
            </li></NavLink>

            <NavLink to='/translate'> <li>
                ...
                <span class="flex-1 ml-3 whitespace-nowrap">Text Translation</span>
            ...
            <NavLink to='/scope'> <li>
                ...
                <span class="flex-1 ml-3 whitespace-nowrap">Future Scope</span>
                </a>
                </li></NavLink>
                <NavLink to='/summary'> <li>                <a href="#" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                <svg aria-hidden="true" class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" fill="#48F4FF" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M5 3a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V5a2 2 0 00-2-2H5zM5 11a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2v-2a2 2 0 00-2-2H5zM11 5a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM11 13a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z"></path></svg>
                <span class="flex-1 ml-3 whitespace-nowrap">Project Summary</span>
                </a>
                </li></NavLink>
