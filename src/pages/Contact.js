        ...
        <div class="-mx-4 flex flex-wrap lg:justify-between">
          <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div class="mb-12 max-w-[570px] lg:mb-0">
              ...
              <h2
                class="text-dark mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px] text-[#48F4FF]"
              >
              ...
              <div class="mb-8 flex w-full max-w-[370px]">
                <div
                  class="bg-[#48F4FF] text-gray-200 mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]"
                >
                  <svg
                    width="24"
                    height="24"
                ...
                <div class="w-full">
                  <h4 class="text-dark mb-1 text-xl font-bold text-gray-500">Our Location</h4>
                  <p class="text-body-color text-base text-gray-100">
                    Haryana, India
                  </p>
                </div>
              </div>
              <div class="mb-8 flex w-full max-w-[370px]">
                ...
                <div class="w-full">
                  <h4 class="text-dark mb-1 text-xl font-bold text-gray-500">Phone Number</h4>
                  <p class="text-body-color text-base text-gray-100">+91 99999 99999</p>
                </div>
              </div>
              <div class="mb-8 flex w-full max-w-[370px]">
                <div
                ...
                <div class="w-full">
                  <h4 class="text-dark mb-1 text-xl font-bold text-gray-500">Email Address</h4>
                  <p class="text-body-color text-base text-gray-100">build@lecnote.com</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <form>
                <div class="mb-6">
                  <input
                    ...
                    class="text-white border-[f0f0f0] focus:border-primary w-full rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none bg-gray-800"
                  />
                </div>
                <div class="mb-6">
                  <input
                ...
                <div class="mb-6">
                  <textarea
                    ...
                    class="text-white  border-[f0f0f0] focus:border-primary w-full resize-none rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none bg-gray-800"
                  ></textarea>
                </div>
                <div>
                  <button
